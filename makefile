...
CPP_FLAGS := --std=c++14 $(shell root-config --cflags) -fopenmp  -fPIC -g -fno-omit-frame-pointer -O2 -pipe -march=native -I $(CLASS_DIR) -I $(COMMON_MACRO_DIR) -I $$ALICE_ROOT/include
